...
export default function App() {
  ...
  const VOICES = [
    ...
    { name: 'Holy molly', id: '6151a25f6a7f5b1e000023', description: `! 나 어메리칸이에요? K-POP 때문에 한국어가 조큼 배우기 시작했어요. 그래서 한국어는… 어… not perfect, but 영어는 완전 confident 있어요!` },
